...
class RelatedDataCacheTransformer(GetViewsTransformer):
    ...
    async def get_views(self, request: Request, items: list, ctx: dict[str, Any]) -> None:
...
class MetadataEnricherTransformer(PostPaginateViewTransformer):
    ...
    async def post_paginate(self, request: Request, pagination: Pagination, ctx: dict[str, Any]) -> None:
...
class AuditTransformer(PreSaveTransformer):
    ...
    async def pre_save(self, request: Request, item, item_data: BaseModel, ctx: dict[str, Any]) -> None:
...
class NotificationTransformer(PostSaveTransformer):
    ...
    async def post_save(self, request: Request, item, item_data: BaseModel, ctx: dict[str, Any]) -> None:
...
class DeleteAuthorizationTransformer(PreDeleteTransformer):
    ...
    async def pre_delete(self, request: Request, item, ctx: dict[str, Any]) -> None:
        user_id = request.headers.get("X-User-ID")
...
class DeleteAuditTransformer(PostDeleteTransformer):
    ...
    async def post_delete(self, request: Request, item, ctx: dict[str, Any]) -> None:
        # Log the deletion
